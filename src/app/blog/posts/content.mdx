...
`const home = {
    label: "Home",
    title: "Amalina's Portfolio",
    description: "Portfolio website showcasing my project in Critical & Creative Thinking for Information Technology Solution ",
    headline: <>Smart Shoes</>,
    subline: (
      <>
        I'm Amalina, I study Critical & Creative Thinking for Information Technology Solution <InlineCode>FLY</InlineCode>, 
        <br /> user experiences. From that, i developed smart shoes project.
      </>
    ),
};`,
    language: "tsx",
